...
ggplot(scores, aes(x = PC1, y = PC2, color = cluster)) +
  ...
  theme_bw()
ggsave("out/plot/pca_biplot_kmeans_UPDATE_km3.pdf", width = 7, height = 6)
...
pdf("out/plot/heatmap_clusters_UPDATE_km3.pdf", width = 12, height = 6)
...
ggsave("out/plot/covariate_categorical_UPDATE_km3_stacked.pdf", width = 10, height = 7)
...
ggsave("out/plot/covariate_categorical_UPDATE_km3_dodge.pdf", width = 10, height = 7)
